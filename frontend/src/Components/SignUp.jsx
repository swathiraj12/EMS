...
const SignUp = () => {
    ...
    return (
        <>
            <div className='container sign-up p-5 my-5 bg-light'>
                <div className="col-6 p-3">
                    <form className='sign-up-form'>
                        ...
                        <div className='d-flex flex-column justify-content-center'>
                            {
                                !isOtpSent ? (
                                    <button type='button' className='genOtpBtn mt-3 mb-3 w-50' onClick={sendOtp}>Generate OTP</button>
                                ) : (
                                    <>
                                        ...
                                        <input type="number"
                                            ...
                                            <button type='button' className='genOtpBtn mt-3 mb-3 w-50' onClick={verifyOtp}>Verify OTP and Sign up</button>
                                    </>
                                )
                            }
                        </div>
